...
const port = 3000;
 ...
 app.get('/', (req, res) => res.send('<meta http-equiv="refresh" content="0; URL=https://www.youtube.com/channel/UC11ZhqeubyDLvEnUWhG6-1g"/>'));
app.listen(port, () => 
  console.log('ARTEX made this and wadi3'))
